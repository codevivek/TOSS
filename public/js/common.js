...
$(document).on("click", ".retossButton", (event) => {
    var button = $(event.target);
    var postId = getPostIdFromElement(button);
    ...
    $.ajax({
        url: `/api/posts/${postId}/retoss`,
        type: "POST",
        success: (postData) => {            
            button.find("span").text(postData.retossUsers.length || "");
...
function createPostHtml(postData, largeFont=false) {
    ...
    if (postData.postedBy._id == userLoggedIn._id) {
        buttons = `<button data-id="${postData._id}" data-toggle="modal" data-target="#deletePostModal"><i class='bx bx-x'></i></button>`;
    }
